...
> - **Boltzmann 图等离子体温度** — 新增 6 维特征（Fe I 谱线温度 + Ca II/Ca I、Hα/C、Si/Mg 比值），CV-RMSE 184.65→180.13↓4.52，但线上 241.86→243.99↑2.13。CV 改善不泛化到线上，与异常值剔除等方向相同的「CV 乐观偏差」模式。详见实验 #30。
